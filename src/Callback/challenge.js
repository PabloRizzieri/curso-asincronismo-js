...
fetchData(`${API}/products`, function(error1, data1){
    ...
    fetchData(`${API}/products/${data1[0].id}`, function (error2, data2) {
        ...
        //en este caso puntual se hace uso de Optional Binding el cual hace una evalucación de las propiedades de un objeto y en vez de arrojar un error devuelve undefined en caso que la propiedad no exista o sea null.
        //igual que las anteriores eb envia una funcion anonima con 2 argumentos, un objeto Error y un objeto de datos
